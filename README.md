...
bash
npm start
The app runs using nodemon index.js and listens on the port defined in PORT (default commonly 5000).
...
Create, update, and delete users (admins, professors, students).
